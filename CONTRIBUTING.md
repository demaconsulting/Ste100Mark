# Contributing to Ste100Mark

Thank you for your interest in contributing to Ste100Mark! We welcome contributions from the community and
...
- **Environment**: Operating system, .NET version, Ste100Mark version
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/demaconsulting/Ste100Mark.git
   cd Ste100Mark
   ```
...
dotnet run --project src/DemaConsulting.Ste100Mark \
...
Ste100Mark uses [DemaConsulting.ReqStream][reqstream] for requirements traceability:
...
By contributing to Ste100Mark, you agree that your contributions will be licensed under the MIT License.

Thank you for contributing to Ste100Mark!

[code-of-conduct]: https://github.com/demaconsulting/Ste100Mark/blob/main/CODE_OF_CONDUCT.md
...
[discussions]: https://github.com/demaconsulting/Ste100Mark/discussions
[issues]: https://github.com/demaconsulting/Ste100Mark/issues
[security]: https://github.com/demaconsulting/Ste100Mark/blob/main/SECURITY.md
