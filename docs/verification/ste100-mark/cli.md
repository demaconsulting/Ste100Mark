...
string and exit code is 0. This scenario verifies `Template-Cli-ArgumentParsing`,
`Template-Cli-Version`, and `Template-Cli-ExitCode`.
...
version string and exit code is 0. This scenario verifies `Template-Cli-Version`.
...
code is 0. This scenario verifies `Template-Cli-ArgumentParsing`, `Template-Cli-Help`, and
`Template-Cli-ExitCode`.
...
This scenario verifies `Template-Cli-ArgumentParsing`, `Template-Cli-Validate`, and
`Template-Cli-ExitCode`.
...
`Template-Cli-ArgumentParsing`, `Template-Cli-OutputChannels`, and `Template-Cli-Silent`.
...
`Template-Cli-ArgumentParsing` and `Template-Cli-Results`.
...
This scenario verifies `Template-Cli-ArgumentParsing` and `Template-Cli-Depth`.
...
specified path and contains version output. This scenario verifies `Template-Cli-ArgumentParsing`
and `Template-Cli-Log`.
...
`Template-Cli-ArgumentParsing` and `Template-Cli-Config`.
...
suppressed, and exit code is 0. This scenario verifies `Template-Cli-ArgumentParsing` and
`Template-Cli-Format`.
...
`Template-Cli-ArgumentParsing` and `Template-Cli-Strict`.
...
`ExitCode` becomes 1. This scenario verifies `Template-Cli-OutputChannels`,
`Template-Cli-ErrorOutput`, and `Template-Cli-ExitCode`.
...
`Template-Cli-ErrorOutput`, `Template-Cli-InvalidArgs`, and `Template-Cli-ExitCode`.
...
finding. This scenario verifies `Template-Cli-Strict` and `Template-Cli-ExitCode`.
